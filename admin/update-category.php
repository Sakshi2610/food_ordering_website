...
<div class="main-content">
    <div class="wrapper">
        <h1 style="color:black;text-align:center;">Update Category</h1><br><br>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        //remove the current image if avaiable
                        if($current_image != "")
                        {
                ...
                //4. redirect to manage category with dmessage

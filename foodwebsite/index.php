...
<body>
    ...
    <div class="container1">
        <nav id="navbar">
            ...
            <a href="manage_cart.php">My cart</a>
        </nav>
...
<p>Enjoy your Food with Your Family.</p>
    ...
    <a href="./morecategory.php" style="text-align:center; color:red"><h4>More Categories</h4></a>
    </section>
            ...
            while ($rows = mysqli_fetch_array($res))
                {
                  $image_name = $rows['image_name'];
                    ?>
                 <form method="post" action="manage_cart.php?Id=<?= $rows['id']; ?>" >
